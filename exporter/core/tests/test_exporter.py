...
from exporter.core.exporter import (
    ExportMode,
...
class TestAreValuesOnDevice:
    ...
    def test_all_values_on_cpu(self):
        ...
        assert are_values_on_device(
            names, tensors, expected_device="cpu", verbose=False
        )
    ...
    def test_wrong_device_check(self):
        ...
        assert not are_values_on_device(
            names, tensors, expected_device="cuda", verbose=False
        )
